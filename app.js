...
function proceedToSurvey(workerId) {
    ...
    // Construct CPX Token: md5(workerId + '-' + secureHashSecret)
    const hash = md5(workerId + "-" + secureHashSecret);
    const surveyUrl = `https://offers.cpx-research.com/index.php?app_id=${appId}&ext_user_id=${workerId}&secure_hash=${hash}&username=${workerId}&subid_1=NexGen`;
